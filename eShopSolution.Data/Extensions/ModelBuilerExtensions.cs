        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductTranslation>().HasData(
                new ProductTranslation()
                {
                    ...
                    SeoDescription = "Sản phẩm áo sơ mi nam trắng Việt Tiến",
                    SeoTitle = "Sản phẩm áo sơ mi nam trắng Việt Tiến",
                    Details = "Sản phẩm áo sơ mi nam trắng Việt Tiến",
                    Description = "Sản phẩm áo sơ mi nam trắng Việt Tiến"
                },
                   new ProductTranslation()
                   {
                       Id = 2,
